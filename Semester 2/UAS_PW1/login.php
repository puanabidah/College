...
<html lang="en">
    ...
    <body id="page-top">
       ...
       <!-- Awal Form Login -->
    <div class="container" id="form" style="margin-bottom: 25px;">
        <form class="login-username" action="aksi_login.php" method="post">
            ...
            <div class="input-group">
                <button class="btn" type="submit" name="simpan">Login</button>
            </div>
            <p class="login-register-text">Belum memiliki akun ? <a href="daftar.php" style="color: blue">Daftar Disini</a>. </p>
        </form>
    </div>
    <!-- Akhir Form Login -->
